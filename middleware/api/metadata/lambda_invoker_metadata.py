...
from middleware.api.metadata.metadata_definitions import MetadataDefinitionsLambda
...
def lambda_handler(event: DIFWAPIGatewayProxyEvent, context):
    """Function called by the AWS Lambda to run Metadata Definitions API"""
    return MetadataDefinitionsLambda(
