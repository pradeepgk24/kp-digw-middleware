...
from middleware.api.global_objects.global_objects import GlobalObjectsLambda
...
def lambda_handler(event: DIFWAPIGatewayProxyEvent, context):
    """Function called by the AWS Lambda to run GLobal Objects API"""
    return GlobalObjectsLambda(
