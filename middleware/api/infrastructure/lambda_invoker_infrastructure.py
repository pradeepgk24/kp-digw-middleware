...
from middleware.api.infrastructure.infrastructure import InfrastructureLambda
...
def lambda_handler(event: DIFWAPIGatewayProxyEvent, context):
    """Function called by the AWS Lambda to run Infrastructure API"""
    return InfrastructureLambda(
