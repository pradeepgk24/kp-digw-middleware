...
from middleware.api.error_handler.error_handler import ErrorHandlerLambda
...
def lambda_handler(event: DIFWAPIGatewayProxyEvent, context):
    """Function called by the AWS Lambda to run Error Handling API"""
    return ErrorHandlerLambda(
