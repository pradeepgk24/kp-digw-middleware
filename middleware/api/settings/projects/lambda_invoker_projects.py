...
from middleware.api.settings.projects.project_settings import ProjectsSettingsLambda
...
def lambda_handler(event: DIFWAPIGatewayProxyEvent, context):
    """Function called by the AWS Lambda to run Project settings API"""
    return ProjectsSettingsLambda(
