...
from middleware.api.pipeline_templates.pipeline_templates import PipelineTemplatesLambda
...
def lambda_handler(event: DIFWAPIGatewayProxyEvent, context):
    """Function called by the AWS Lambda to run Pipeline Templates API"""
    return PipelineTemplatesLambda(
